...
public class Quiz extends JFrame implements ActionListener {
    ...
    Quiz(String name) {
        this.name = name;
        setBounds(5, 5, 1280, 720); // Updated screen size to optimize dimensions
        ...
        image.setBounds(0, 0, 1280, 300); // Adjusted image bounds for new screen size
        add(image);
        ...
        lifeline.setBounds(730, 600, 200, 30);
        ...
        submit.setBounds(960, 600, 200, 30);
    ...
    public void paint(Graphics g) {
        ...
        if (timer > 0) {
            g.drawString(time, 900, 500); // Adjusted x-coordinate for left alignment
        } else {
            g.drawString("Times up!!", 900, 500); // Adjusted x-coordinate for left alignment
        }
